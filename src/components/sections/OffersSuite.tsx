...
import { Zap, Plus, Search, Filter, LayoutGrid, List, ChevronUp, HelpCircle, Building2, Megaphone, Layers, Image as ImageIcon, History, Pencil } from "lucide-react";
import { Container, Reveal, Section, SplitWords } from "../ui/primitives";
import { Window, BRL } from "../mock/atoms";
      ...
      <Container>
        <div className="grid items-start gap-8 lg:grid-cols-[0.8fr_1.2fr]">
          <div className="lg:sticky lg:top-28">
            <SplitWords text="Todas as suas ofertas em *uma *visão." className="display text-4xl sm:text-5xl lg:text-6xl" />
            <Reveal delay={0.1}>
    ...
    <Section className="!pt-0">
      <Container>
        <div className="grid items-center gap-10 lg:grid-cols-[0.8fr_1.2fr]">
          <div>
            <SplitWords text="Seu Meta Ads *dentro da operação." className="display text-4xl sm:text-5xl lg:text-6xl" />
            <Reveal delay={0.1}>
              <p className="mt-6 max-w-md text-lg text-fg-2">
